        ...
        <div className="container">
            ...
            <nav className="d-flex justify-center">
                ...
                <Link to="/rss.xml" 
                    ...
                    className="footer__icon"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 8 8"><rect width="8" height="8" rx="1.5" fill="currentColor"></rect><circle cx="2" cy="6" r="1"></circle><path d="m 1,4 a 3,3 0 0 1 3,3 h 1 a 4,4 0 0 0 -4,-4 z"></path><path d="m 1,2 a 5,5 0 0 1 5,5 h 1 a 6,6 0 0 0 -6,-6 z"></path></svg>                
                </Link>
